...
const  CTAsection = ({name=" Retro Shoe"}) => {
  console.log(name);
  return (
    <div className="flex p-6  font-mono w-5/12 ">
      <div className="flex-none w-48 mb-10 relative z-10 before:absolute before:top-1 before:left-1 before:w-full before:h-full before:bg-teal-400">
        <img src={img} alt="" className="absolute z-10 inset-0 w-full h-full object-cover rounded-lg" loading="lazy" />
      </div>
